...
filename = "Predictions/PD_SEG_onlylungs_preds_onlylungs.csv"
df_acc.to_csv(filename, mode='a', sep=',')


## Get predictions

json = [path+'PD_onlylungs_model1.json', path+'PD_onlylungs_model2.json', path+'PD_onlylungs_model3.json']
h5 = [path+'PD_onlylungs_model1.h5', path+'PD_onlylungs_model2.h5', path+'PD_onlylungs_model3.h5']

### Adding the predictions to the dataframe
all_dict = {"Model_name": [], "Val_data": [], "Preds_model1": [], "Preds_model2": [], "Preds_model3": []}
all_dict["Model_name"].append('S, Multiclass, Only lungs')
all_dict["Val_data"].append('PadChest test only lungs')
