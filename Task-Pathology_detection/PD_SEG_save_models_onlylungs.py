...
filename = "PD_save_models_onlylungs.csv"
...
for lr in learning_rate_list:
    ...
    model_acc1 = PD_save_models(json_name=path+"PD_SEG_onlylungs_model1.json", h5_name=path+"PD_SEG_onlylungs_model1.h5", lr=lr)
    model_acc2 = PD_save_models(json_name=path+"PD_SEG_onlylungs_model2.json", h5_name=path+"PD_SEG_onlylungs_model2.h5", lr=lr)
    model_acc3 = PD_save_models(json_name=path+"PD_SEG_onlylungs_model3.json", h5_name=path+"PD_SEG_onlylungs_model3.h5", lr=lr)
